...
!Interpolate and write
 ...
 &[nccount(1:2)])
 write(*,*) minval(val2d1),maxval(val2d1)
 WHERE(val2d1.GE.interp_fill_value); val2d1=dble(0); END WHERE
 val2d2=mesh2mesh_ad_interp(&
 ...
 CALL ncwrite3d(nid(2),'zeta',ncstart(1:3),nccount(1:3),&
 &RESHAPE(val2d2,nccount(1:3)))
...
!Interpolate u-velocities
 ...
 CALL ncwrite3d(nid(2),'ubar',ncstart(1:3),nccount(1:3),&
 &RESHAPE(val2d2,nccount(1:3)))
...
!Interpolate v-velocities
 ...
 CALL ncwrite3d(nid(2),'vbar',ncstart(1:3),nccount(1:3),&
 &RESHAPE(val2d2,nccount(1:3)))
...
!Close open streams
 ...
 WRITE(*,*) 'ad_interp DONE'
END PROGRAM ad_interp
